...
.profile-live-thumb-link { display: block; position: relative; width: 234px; flex-shrink: 0; border-radius: 8px; overflow: hidden; }
...
.profile-live-info { display: flex; flex-direction: column; justify-content: space-between; min-width: 0; flex: 1; padding: 2px 0; }
