...
/* 
  ...
  2. padding-right: 2px -> 브라우저가 ...을 그릴 픽셀 공간 넉넉히 확보 (짜투리 잘림 방지)
...
.profile-live-title { width: 100%; text-align: right; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; word-break: break-word; padding-right: 2px; font-size: 13px; font-weight: 700; color: #1a1d29; line-height: 1.3; }
