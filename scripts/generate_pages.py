...
.live-dot { display: none; position: absolute; left: 5px; top: 50%; transform: translateY(-50%); width: 4px; height: 4px; border-radius: 50%; background: #e53935; animation: live-dot-pulse 1.4s infinite; --live-dot-spread: 1.5px; }
...
@media (max-width: 600px) {
    ...
    .live-dot { left: 2px; width: 2px; height: 2px; --live-dot-spread: 0.75px; }
