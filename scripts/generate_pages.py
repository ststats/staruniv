...
.live-dot { display: none; position: absolute; left: 5px; top: 50%; width: 4px; height: 4px; border-radius: 50%; background: #e53935; animation: live-dot-blink 1s infinite; --live-dot-pos: translateY(-50%); }
.live-dot.is-live { display: block; }
@keyframes live-dot-blink {
  0%, 49.9% { transform: var(--live-dot-pos) scale(1); opacity: 1; }
  50%, 100% { transform: var(--live-dot-pos) scale(0.4); opacity: 0.4; }
}
...
.fa-bar-item .live-dot { position: static; flex-shrink: 0; width: 4px; height: 4px; transform: none; left: auto; top: auto; --live-dot-pos: ; }
...
@media (max-width: 600px) {
    ...
    .live-dot { left: 2px; width: 2px; height: 2px; }
