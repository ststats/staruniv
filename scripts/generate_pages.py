...
.profile-live-thumb-link { display: block; position: relative; width: 160px; flex-shrink: 0; border-radius: 8px; overflow: hidden; }
              ...
              if (result) {{
                  ...
                  if (broadStart) {{
                      ...
                      if (!isNaN(startDate.getTime())) {{
                          ...
                          const elapsedText = eh > 0 ? `${{eh}}시간 ${{em}}분` : `${{em}}분`;
                          metaParts.push(elapsedText + ' 방송중');
                      }}
                  }}
