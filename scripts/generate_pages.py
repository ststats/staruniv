...
/* Grid 구조로 원복하고 하위 요소 너비를 100%로 강제 고정 */
.profile-live-info { display: grid; grid-template-rows: repeat(3, 1fr); align-items: center; min-width: 0; flex: 1; padding: 2px 0; }
.profile-live-title, .profile-live-viewer, .profile-live-elapsed { display: block; width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; text-align: right; }
.profile-live-title { font-size: 13px; font-weight: 700; color: #1a1d29; }
.profile-live-viewer, .profile-live-elapsed { font-size: 12px; font-weight: 600; color: #6b6f79; }
