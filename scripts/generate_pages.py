...
/* 브라우저 text-overflow 우측 여백 버그를 원천 차단하는 -webkit-line-clamp 방식 적용 */
.profile-live-info { display: flex; flex-direction: column; justify-content: space-evenly; min-width: 0; flex: 1; padding: 2px 0; }
.profile-live-title { width: 100%; text-align: right; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; word-break: break-all; font-size: 13px; font-weight: 700; color: #1a1d29; }
.profile-live-viewer, .profile-live-elapsed { width: 100%; text-align: right; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; word-break: break-all; font-size: 12px; font-weight: 600; color: #6b6f79; }
