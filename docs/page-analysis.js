...
// 기간 칩에 따라 보여줄 개월 수. 점수 자체는 늘 같은 방식(개인 폼 반감기 90일)으로 계산하고,
...
const RATING_HELP = {
    title: '레이팅',
    lead: '티어 기준선과 최근 경기력을 합친 뒤, 표본의 불확실성을 차감한 순위 점수입니다.',
    rows: [
        ['계산', '상대 강도와 경기 형식을 반영'],
        ['최근성', '개인 폼 반감기 90일'],
        ['기준선', '티어 간격 반감기 540일'],
        ['승급', '승급 전 경기는 당시 티어로 계산'],
        ['보수 점수', '추정 레이팅 − 표준오차 1.5배'],
        ['비교', '같은 티어 순위와 개인 변화 확인용'],
        ['구간', '전체 18개월 · 1년 12 · 90일 3 · 30일 1'],
        ['기간 칩', '가로축만 자릅니다 (계산은 동일)'],
    ],
    note: '최근 기록이 적을수록 보수적으로 내려가며, 그 시점에 최근 1년 기록이 없으면 선이 끊깁니다.',
};
