...
function renderMemberGroup(title, members) {
    ...
    return `
        <div class="section-title" data-en="${ROLE_EN[title] || 'ROSTER'}"><span class="section-title-label">${escapeHTML(title)}</span><span class="title-count-badge">${sorted.length}명</span></div>
